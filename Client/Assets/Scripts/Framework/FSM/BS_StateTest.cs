...
namespace FSM
{
	...
	public class StateOpen : BS_State
	{
	...
	public class StateClose : BS_State
	{
	...
	public class Open2Close : BS_Transition
	{
		public Open2Close(string name, BS_IState from = null, BS_IState to = null) : base(name, from, to){}
	...
	public class Close2Open : BS_Transition
	{
		public Close2Open(string name, BS_IState from = null, BS_IState to = null) : base(name, from, to){}
		public override bool ShouleEnd() { return BS_StateTest.can == true; }
        public override bool ShouldBegin()
        {
            return BS_StateTest.can == true;
	...
	*/
    ...
    {
	    public BS_StateMachine fsm { get; protected set; } = null;
	    ...
	    private void Awake()
	    {
		    ...
		    fsm = new BS_StateMachine("FSM", stClose);
